      ...
      <Navbar collapseOnSelect expand="lg" variant="light">
        <Container>
          <NavbarBrand href='#home' className='logoo'>
            {/* Main Logo */}
            <NavLink to="/">
              <img className='image-fluid' src={logo} height={45} width={200} alt="jobnexus logo" />
            </NavLink>
          </NavbarBrand>
                  ...
                  <Modal show={show} onHide={handleClose} centered>
                    ...
                    <Modal.Body>
                      <div className='d-flex justify-content-around align-items-center'>
                        {/* Recruiter Section */}
                        <div className='text-center'>
                          <img className='img-fluid' height={200} width={200} src={recruiterImage} alt="Recruiter" />
                        ...
                        {/* Job Seeker Section */}
                        <div className='text-center'>
                          <img className='img-fluid' height={200} width={200} src={jobseeker} alt="Job Seeker" />
                          <NavLink to="/register/jobseeker">
                            <button className='btn btn-outline-primary ' onClick={handleClose}>Job Seeker</button>
                          </NavLink>
                        </div>
                      </div>
                    </Modal.Body>
                ...
                <div className='d-flex justify-content-center'>
                  <div className="dropdown" style={{ width: "160px" }}>
                    <img className="dropdown-toggle border-dark border rounded-5 cursor"
                      ...
                      height={50} width={50} data-bs-toggle="dropdown" aria-expanded="false" alt="Profile">
                    </img>
